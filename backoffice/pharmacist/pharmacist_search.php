<form id="sfrm" name="sfrm" method="GET" action="./admin.template.php">
    ...
    <table class='tbl1'>
        ...
        <tr>
            ...
            <th>가입일 &nbsp; <input type="checkbox" id="schChkDate" name="schChkDate" value="Y"
        ...
        <tr>
            ...
            <td>
                <select id="keyfield" name="keyfield" class="w120">
                    <option value="t1.USER_NAME" <? if ($_search["keyfield"] == "t1.USER_NAME") echo "selected"; ?>>약사명
                    </option>
                    <option value="t1.USER_ID" <? if ($_search["keyfield"] == "t1.USER_ID") echo "selected"; ?>>
                        약사아이디
                    </option>
                    <option value="t2.USER_PHONE" <? if ($_search["keyfield"] == "t2.USER_PHONE") echo "selected"; ?>>연락처
                    </option>
                </select>
        ...
        <!--<tr>
            ...
            <td>
                <select id="keyfield2" name="keyfield2" class="w120">
                    <option value="t1.mm_name" <?/* if ($_search["keyfield2"] == "t1.user_name") echo "selected"; */?>>약사넘버
                    </option>
                    <option value="t1.mm_name" <?/* if ($_search["keyfield2"] == "t1.user_name") echo "selected"; */?>>소속약국
                    </option>
                </select>
