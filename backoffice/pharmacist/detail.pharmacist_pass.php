...
<div><b>○ 비밀번호수정</b></div>
<form id="frm" name="frm" method="post" action="./_action/pharmacist.do.php" onSubmit="return chk_form(this);" style="display:inline;" target="actionForm">
    <input type="hidden" id="Mode" name="Mode" value="pharmacist_pass">
