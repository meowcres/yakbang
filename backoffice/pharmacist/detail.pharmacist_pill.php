        ...
        while ($row_002 = $db->sql_fetch_array($res_002)) {
            ...
            if ($row_002["USER_STATUS"] == "1") {
                ...
                <tr>
                    ...
                    <td style="padding-left:10px"><?= $member_status_array[$row_002["USER_STATUS"]] ?></td>
                    ...
                    <td>
                        &nbsp;&nbsp; <?= "( " . number_format($row_002["LOG_COUNT"]) . " ) : " . $row_002["LAST_LOGIN"] ?></td>
                    <td class="center">
                ...
                <tr>
                    <td class="center"><?= $row_002["REG_DATE"] ?></td>
                    <td class="center"><?= $member_status_array[$row_002["USER_STATUS"]] ?></td>
                    <td colspan="4" class="left" style="line-height:180%;">
                        <b>[ 활동중지시간 :
                            <?php
