...
$where_array[] = "t1.CD_TYPE IN ('REQUEST')";
...
?>
<div id="Contents">
    <h1>커뮤니티 &gt; 분류관리 &gt; <strong> 문의 분류관리</strong></h1>

    <div class="right">
        <input type="button" value="문의 분류 등록" class="btnGreen w120 h32"
               onClick="openWin('./board/popup.type_request_register.php','typeRegister',700,270,'scrollbars=no');">
    </div>
    ...
    <table class='tbl1'>
        ...
        if ($totalnum > 0) {
                ...
                <tr>
                    ...
                    <td class="center">
                        <input type="button" value="수정" class="btnBlue w60 h24"
                               onClick="openWin('./board/popup.type_request_update.php?CD_KEY=<?= $row_002['CD_KEY'] ?>','typeRegister',700,270,'scrollbars=no');">&nbsp;
            ...
            ?>
            <tr>
                <td colspan="6" class='center' style="height:150px;">등록된 문의 분류가 없습니다.</td>
            </tr>
            <?
        }
        ?>
