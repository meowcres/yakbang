...
?>
<div id="Contents">
    <h1>커뮤니티 &gt; 분류관리 &gt; <strong> FAQ 분류관리</strong></h1>

    <div class="right">
        <input type="button" value="FAQ 분류 등록" class="btnGreen w120 h32"
               onClick="openWin('./board/popup.type_faq_register.php','typeRegister',700,270,'scrollbars=no');">
    </div>
    ...
    <table class='tbl1'>
        ...
        if ($totalnum > 0) {
            ...
            ?>
            <tr>
                <td colspan="6" class='center' style="height:150px;">등록된 FAQ 분류가 없습니다.</td>
            </tr>
            <?
        }
        ?>
