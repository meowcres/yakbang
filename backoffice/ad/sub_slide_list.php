...
<div id="Contents">
    <h1>광고관리 > SUB SLIDE 광고 > <strong>SUB SLIDE 광고 목록</strong></h1><br>
    ...
    <form id="sfrm" name="sfrm" method="GET" action="./admin.template.php">
        ...
        <input type="hidden" id="search_type" name="search_type" value="3">
    ...
    <form id='frm' name='frm'>
        ...
        <table class='tbl1'>
            ...
            if ($totalnum > 0) {
                ...
                while ($row_002 = $db->sql_fetch_array($res_002)) {
                    ...
                    $up_url = "./admin.template.php?slot=ad&type=sub_slide_update&idx=".$row_002["IDX"]."&page=".$page.$_opt ;
                    ?>
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <input type="button" value="삭제" class="Small_Button btnRed w50 h24"
                                   onClick="del_sub('<?= $row_002["IDX"] ?>', '<?= $row_002["AD_TYPE"] ?>');">
                        </td>
                    </tr>
                    <?
                    $_j++;
                ...
                ?>
                <tr>
                    <td colspan="7" style='height:200px;' class='center'>등록된 MAIN SLIDE 광고가 없습니다.</td>
                </tr>
                <?
            }
            ?>
        ...
        <div id="Paser">
            <?
            $paging = new paging("./admin.template.php", "slot=ad&type=sub_slide_list", $offset, $page_block, $totalnum, $page, $_opt);
            $paging->pagingArea("", "");
            ?>
        </div>
...
<!--
function del_sub(n, p){
  if(confirm("정말 삭제하시겠습니까? \n\n삭제후에는 복구가 불가능합니다.")){

    location.href="./_action/ad.do.php?mode=del_sub&idx="+n+"&ad_type="+p;
