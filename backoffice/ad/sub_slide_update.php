...
$qry_001 .= " WHERE t1.IDX = '{$idx}' AND t1.AD_TYPE = '3' ";
...
?>
<div id="Contents">
	<h1>광고관리 &gt; SUB SLIDE 광고 &gt; <strong>SUB SLIDE 광고 수정</strong></h1><br>
	...
	<input type="hidden" id="mode" name="mode" value="up_sub">
  ...
  <input type="hidden" id="ad_type" name="ad_type" value="<?=$row_001["AD_TYPE"]?>">
	...
	<div style="margin-top:20px;" class="center">
		...
		<input type="button" value="목 록" class="Button btnRed w120" onClick="location.href='./admin.template.php?slot=ad&type=sub_slide_list&<?= $_opt ?>'">
	</div>
	</form>
