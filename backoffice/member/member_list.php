...
?>
<div id="Contents">
    <h1>회원관리 &gt; 회원 관리 &gt; <strong>회원목록</strong></h1>

    <? include_once "./member/member_search.php"; ?>

    <div class="left" style="margin-top:15px;"><b>○ 회원 목록</b> ( 검색 인원 : <?= number_format($totalnum) ?> 명 )</div>
    <table>
        <colgroup>
            <col width="10%"/>
            <col width="6%"/>
