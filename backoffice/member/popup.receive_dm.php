...
?>
    <div id="Popup_Contents" style="padding:10px;">
        <h1>회원관리 &gt; 쪽지관리 &gt; <strong> 받은 쪽지 목록</strong></h1>
        <table class="tbl1" summary="받은 쪽지 목록">
            <colgroup>
                <col width="18%"/>
                <col width="6%"/>
                <col width="18%"/>
            ...
            if ($totalnum > 0) {
                ...
                ?>
                <tr>
                    <td colspan="7" style='height:200px;' class='center'>받은 쪽지가 없습니다.</td>
                </tr>
                <?
            }
            ?>
