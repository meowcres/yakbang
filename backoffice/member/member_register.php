<div id="Contents">
    <h1>회원관리 &gt; 회원 관리 &gt; <strong>회원 등록</strong></h1>

    <div><b>○ 회원 기본정보</b></div>

    <form name="frm" method="post" enctype="multipart/form-data" action="./_action/member.do.php"
        ...
        <table class="tbl1">
            ...
            <tr>
                ...
                <th>회원구분</th>
                <td class="left"><?= $member_type_array[1] ?></td>
            </tr>
            ...
            <tr>
                <th>비밀번호</th>
                <td><input type="password" value="" id="user_pass" name="user_pass" class="w40p"/> &nbsp; ( 영문자 + 숫자 +
                    특수문자 8~20 )
                </td>
                <th>비밀번호 확인</th>
                <td><input type="password" value="" id="re_pass" name="re_pass" class="w40p"/> &nbsp; ( 영문자 + 숫자 + 특수문자
                    8~20 )
                </td>
            </tr>
            ...
            <tr>
                <th>이 름</th>
                <td><input type="text" value="" id="user_name" name="user_name" class="wid90p"/></td>
                <th>연 락 처</th>
                <td>
                    <select id="phone1" name="phone1" class="w90">
                        <?
                    ...
                    <input type="text" id="phone2" name="phone2" value="" class="w90 onlyNumbers" maxlength="4"
                           onkeyup="passTab('phone2','phone3',4);"> -
                    <input type="text" id="phone3" name="phone3" value="" class="w90 onlyNumbers" maxlength="4">
                </td>
            </tr>
