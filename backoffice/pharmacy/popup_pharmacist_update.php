...
<div class="adm_table_style02">
	...
	<form id="sfrm" name="sfrm" method="POST" action="../_action/pharmacy.do.php" target="actionForm">
  ...
  <table>
    ...
    <tr>
      ...
      foreach ($pharmacist_status_array as $key => $val) {
        $_selected = $key == $row_001["P_STATUS"] ? "selected" : "" ;
    ...
    <tr>
			<th>유지기간</th>
			<td colspan="3">
        <input type="text" id="s_date" name="s_date" value="<?= $row_001["S_DATE"] ?>" class="w100" readonly> ~ <input type="text" id="e_date" name="e_date" value="<?= $row_001["E_DATE"] ?>" class="w100" readonly>
      </td>
		</tr>
    <tr>
  ...
  <div class="center w100p">
    <input type="submit" value="정보관리" class="btn btn16 w100 mt10"> &nbsp;
    <input type="button" value="소속제외" onClick="del_pp('<?=$idx_key?>')" class="btn btn14 w100 mt10"> &nbsp;
