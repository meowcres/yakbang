...
$_where[] = " t2.OP_ID = '{$_op["OP_ID"]}' ";
$_where[] = " t1.REG_DATE >= (CURDATE() - INTERVAL 3 MONTH) ";
...
<div id="content">
    <div class="sub_tit">처방전 리스트 > 내 처방전 목록</div>
    <div id="cont">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center"><?= $prescription_status_array[$row_002["PS_STATUS"]] ?></td>
                            <td align="center"><?= $row_002["mm_name"] ?></td>

                            <td align="center"><?= $row_002["OP_NAME"] ?></td>
                            <td align="center"><?= $pre_status_array[$row_002["PRE_STATUS"]] ?></td>
                            
                            <td align="center">
                                <?php
                                if ($row_002["PRE_STATUS"] == "2") {
                                    ?>
                                    ...
                                    ?>
                                    <input type="button" style="width:100px;height:24px;background-color:#adadad;color:white;border-radius:5px;" id="pre_status_btn"
                                           onClick="openWin('./prescription/popup_prescription_view.php?PS_CODE=<?= $row_002["PS_CODE"] ?>&OP_ID=<?= $_op["OP_ID"] ?>','preupdate',1000,800,'scrollbars=no');"
                                           value="보기" >
                                    <?
                                }
                                ?>
                        ...
                        <?
                            ...
                            ?>
                            <tr>
                                <td colspan="8" height="200" align="center">처리한 처방전이 없습니다</td>
                            </tr>
                            <?
                        }
                        ?>      
        ...
        <div align="center" style="padding-top:10px;height:120px;">
            <?
            $_url = "&slot=prescription&type=prescription_list_own";
