...
<div id="Contents">
    ...
    <div style="margin-top:15px;"><b>처방약 리스트 </b> ( <?= number_format($totalnum) ?> 개 )</div>
            ...
            foreach ($xml->body->items->item as $obj) {
                ...
                <tr>
                    ...
                    <td>
                       ...
                       onClick="location.href='../_action/prescription.do.php?Mode=add_pill&pCode=<?= urlencode($obj->gnlNmCd) ?>&pName=<?= urlencode($obj->gnlNm) ?>&ps_code=<?=$ps_code?>'" value="선택">
                    </td>
                </tr>
                <?php
            }
