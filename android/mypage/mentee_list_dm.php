...
<div class="coNtent2">
    <div class="dm_wrap">
        ...
        <div class="dMiNput">
            ...
            <input type="button" id="btn" title="보내기버튼" value="보내기"
                   onclick="dm_add('<?= $mentor_id ?>', '<?= $mentee_id ?>');">
        </div>
    </div>
</div>
    ...
    function dm_add(send_id, receive_id) {
        ...
        $.ajax({
            ...
            success: function (_res) {
                ...
                switch (_res) {
                    case "0" :
                        location.href = "./mentee_list_dm.php?mentee_id=" + receive_id + "&mentor_id=" + send_id;
                        break;
                    default :
                        alert("실패");
                        break;
...
<script>
    ...
    function ajax_change() {
        ...
        _frm.append("Mode", "ajax_call_mentee");
        _frm.append("mentee_id", mentee_id);
        _frm.append("mentor_id", mentor_id);
